...
os.environ["REQUESTS_CA_BUNDLE"] = st.secret["REQUESTS_CA_BUNDLE"]
...
with col1:
    st.markdown("**Note**: gptMailPolisher was inspired by [@GregKamradt](https://twitter.com/GregKamradt)'s work and slightly \
                modified by **James Silva Garcia**. \n\n Often professionals would like to improve their emails, but don't have \
                the skills to do so. \n\n This tool will help you improve your email skills by converting your emails into a \
                more professional format. This tool is powered by [LangChain](https://langchain.com/) and [OpenAI](https://openai.com) \
...
st.write('Instructions to generate an API key are available [here](https://help.openai.com/en/articles/4936850-where-do-i-find-my-secret-api-key)', icon="⚠️.")

openai_api_key = get_api_key()

if openai_api_key != "":
  st.markdown("## Draft text to polish")
